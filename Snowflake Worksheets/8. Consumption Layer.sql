...
GRANT ALL ON ALL TABLES IN SCHEMA amazon_sales_dwh.consumption TO ROLE sysadmin;
GRANT ALL ON ALL SEQUENCES IN SCHEMA amazon_sales_dwh.consumption TO ROLE sysadmin;
